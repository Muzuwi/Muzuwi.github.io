...
our prime target for reversing. You can see some example requests in the [docs/net.md](https://github.com/Muzuwi/fools22/docs/net.md) file in my notes repository.
...
I opted to go for the nuclear route of [writing my own script disassembler](https://github.com/Muzuwi/fools22/tools/discript.cpp) to help facilitate 
...
_You can check out the whole script in [cc3/script.txt](https://github.com/Muzuwi/fools22/cc3/script.txt) at my notes repository._
...
my findings in the [docs/api.md](https://github.com/Muzuwi/fools22/docs/api.md) file.
...
![](/assets/img/2022-04-10-fools2022/cbcdec.png)
