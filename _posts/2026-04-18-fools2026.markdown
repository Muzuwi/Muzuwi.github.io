...
What I refer to as a "magic box" is in fact just the initial state of the machine, which is initialized from a default state hardcoded in the state (`0x1600` bytes long).
